# ============================================================
#  Iris Dataset REST API  |  Built with plumber
# ============================================================
...
# ============================================================
#  GET /iris  –  Return rows, optionally filtered
# ============================================================
#* @get /iris
...
# ============================================================
#  GET /iris/species  –  Unique species
# ============================================================
#* @get /iris/species
#* @serializer json
function() {
...
# ============================================================
#  GET /iris/summary  –  Descriptive stats per species
# ============================================================
#* @get /iris/summary
#* @serializer json
function() {
...
# ============================================================
#  GET /iris/{id}  –  Single row by row index
# ============================================================
#* @get /iris/<id:int>
#* @serializer json
function(id, res) {
